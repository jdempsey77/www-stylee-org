...
export default function Resume() {
  ...
  return (
      ...
      {/* Header */}
      <section className="py-6 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-slate-900 dark:via-blue-900 dark:to-purple-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center pb-2">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 mb-3 font-semibold">
