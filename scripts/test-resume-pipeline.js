...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body { font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #334155; background: white; padding: 40px; max-width: 1000px; margin: 0 auto; }
        .header { text-align: center; margin-bottom: 40px; border-bottom: 2px solid #e2e8f0; padding-bottom: 30px; background: linear-gradient(135deg, #eff6ff 0%, #e0e7ff 50%, #f3e8ff 100%); padding: 40px; border-radius: 12px; }
        ...
        .section h2 { font-size: 2rem; font-weight: bold; color: #1e293b; margin-bottom: 30px; border-bottom: 2px solid #e2e8f0; padding-bottom: 10px; display: flex; align-items: center; }
        .section h2::before { content: "💼"; margin-right: 12px; font-size: 1.5rem; }
        .timeline { position: relative; }
        .job { position: relative; padding-left: 40px; margin-bottom: 20px; }
        .job::before { content: ""; position: absolute; left: 8px; top: 8px; width: 12px; height: 12px; border-radius: 50%; background: linear-gradient(45deg, #3b82f6, #1d4ed8); box-shadow: 0 2px 8px rgba(59, 130, 246, 0.3); }
        .job-card { background: white; border-radius: 8px; padding: 24px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.05); border-left: 4px solid #3b82f6; }
        .job h3 { font-size: 1.4rem; font-weight: 600; color: #1e293b; margin-bottom: 8px; }
        .job .dates { display: inline-block; background: linear-gradient(45deg, #3b82f6, #1d4ed8); color: white; padding: 4px 12px; border-radius: 20px; font-size: 0.9rem; font-weight: 600; margin-bottom: 8px; }
        .job .company { color: #64748b; font-weight: 500; margin-bottom: 15px; }
        .job .description { color: #475569; line-height: 1.6; }
        .job:nth-child(1) .job-card { border-left-color: #3b82f6; }
        .job:nth-child(1)::before { background: linear-gradient(45deg, #3b82f6, #1d4ed8); }
        .job:nth-child(2) .job-card { border-left-color: #10b981; }
        .job:nth-child(2)::before { background: linear-gradient(45deg, #10b981, #059669); }
        .job:nth-child(3) .job-card { border-left-color: #8b5cf6; }
        .job:nth-child(3)::before { background: linear-gradient(45deg, #8b5cf6, #7c3aed); }
        .job:nth-child(4) .job-card { border-left-color: #06b6d4; }
        .job:nth-child(4)::before { background: linear-gradient(45deg, #06b6d4, #0891b2); }
        .job:nth-child(5) .job-card { border-left-color: #f59e0b; }
        .job:nth-child(5)::before { background: linear-gradient(45deg, #f59e0b, #d97706); }
        .job:nth-child(6) .job-card { border-left-color: #ef4444; }
        .job:nth-child(6)::before { background: linear-gradient(45deg, #ef4444, #dc2626); }
        .job:nth-child(7) .job-card { border-left-color: #ec4899; }
        .job:nth-child(7)::before { background: linear-gradient(45deg, #ec4899, #db2777); }
        .job:nth-child(8) .job-card { border-left-color: #6366f1; }
        .job:nth-child(8)::before { background: linear-gradient(45deg, #6366f1, #4f46e5); }
        .job:nth-child(9) .job-card { border-left-color: #14b8a6; }
        .job:nth-child(9)::before { background: linear-gradient(45deg, #14b8a6, #0d9488); }
        .job:nth-child(10) .job-card { border-left-color: #84cc16; }
        .job:nth-child(10)::before { background: linear-gradient(45deg, #84cc16, #65a30d); }
        .job:nth-child(11) .job-card { border-left-color: #f59e0b; }
        .job:nth-child(11)::before { background: linear-gradient(45deg, #f59e0b, #d97706); }
        .job:nth-child(12) .job-card { border-left-color: #f43f5e; }
        .job:nth-child(12)::before { background: linear-gradient(45deg, #f43f5e, #e11d48); }
        .job:nth-child(13) .job-card { border-left-color: #8b5cf6; }
        .job:nth-child(13)::before { background: linear-gradient(45deg, #8b5cf6, #7c3aed); }
    </style>
</head>
<body>
    <div class="header">
    ...
    <div class="content">
        <div class="section">
            ...
            <p style="color: #475569; line-height: 1.6; font-size: 1.1rem;">${resumeData.summary}</p>
        </div>
